...
EMSCRIPTEN_KEEPALIVE void
	curve25519_generate_public(u8 public[static 32],
				   const u8 private[static 32])
{
...
EMSCRIPTEN_KEEPALIVE void key_to_base64(char base64[static 45],
					const u8 key[static 32])
{
	unsigned int i;
	...
	encode_base64(&base64[i * 4],
		      (const u8[]){ key[i * 3 + 0], key[i * 3 + 1], 0 });
	base64[45 - 2] = '=';
	base64[45 - 1] = '\0';
}
